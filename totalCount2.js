...
let x = {
    "text": "Voot-Kids Automation",
    "attachments": [
        {
            "fallback": "Newman Run Summary",
            "color": "#36a64f",
            "title": "Total count tests",
            ...
            "fields": [
                ...
                {
                    "title": "No. Of API Requests",
                },
                {
                    "title": "No. Of Test Cases",
                },
                {
                    "title": "No. Of Test Failures",
                },
                {
                    "title": "Test Passed details",
                },
                {
                    "title": "Test Pass OR Fail Results",
                }
            ]
        }
    ]
...
newman.run({
    ...
    if (err || summary.error) {
        ...
        x.attachments[0].fields[0].value = summary.run.stats.iterations.total
        x.attachments[0].fields[1].value = summary.run.stats.requests.total
        x.attachments[0].fields[2].value = summary.run.stats.assertions.total
        x.attachments[0].fields[3].value = summary.run.stats.assertions.failed
        x.attachments[0].fields[4].value = "(1) " + pass1A + `\n` + "(2) " + pass1B +`\n\n` + "(3) " + pass2A + `\n` + "(4) " + pass2B + `\n` + "(5) " + pass2C + `\n` + "(6) " + pass2D + `\n\n` + "(7) " + pass3A + `\n` + "(8) " + pass3B + `\n` + "(9) " + pass3C + `\n` + "(10) " + pass3D + `\n\n` + "(11) " + pass4A + `\n` + "(12) " + pass4B + `\n` + "(13) " + pass4C + `\n` + "(14) " + pass4D + `\n` + "(15) " + pass4E + `\n` + "(16) " + pass4F + `\n\n` + "(17) " + pass5A + `\n` + "(18) " + pass5B + `\n` + "(19) " + pass5C + `\n` + "(20) " + pass5D + `\n` + "(21) " + pass5E + `\n` + "(22) " + pass5F; // for Slack

        let errorFlag = x.attachments[0].fields[3].value;
        ...
        y.attachments[0].fields[5].value = testFailedGmail;
        x.attachments[0].fields[5].value = testFailedSlack;
        ...
        if (errorFlag > 0) {
            ...
            x.attachments[0].fields[5].value = "All tests are successfully passed! :slightly_smiling_face:"
        }        
        var options = {
            'method': 'POST',
                       ...
                       <table width="640" border="1" align="center" cellpadding="8" cellspacing="0" bgcolor="#FFFFFF" style="border: 1px solid lightgray;">
                           <tbody>
                               ...
                               <tr>
                                   ...
                                   <td style="text-align: center;color:green;font-weight: bold;">${y.attachments[0].fields[0].value}</td>
                               </tr>
                               <tr>
                                   <td width="320" style="text-align: center;color:green;font-weight: bold;">No. Of API Requests</td>
                                   <td style="text-align: center;color:green;font-weight: bold;">${y.attachments[0].fields[1].value}</td>
                               </tr>
                               <tr>
                                   <td width="320" style="text-align: center;color:green;font-weight: bold;">No. Of Test Cases</td>
                                   <td style="text-align: center;color:green;font-weight: bold;">${y.attachments[0].fields[2].value}</td>
                               </tr>
                               <tr>
                                   <td width="320" style="text-align: center;color:green;font-weight: bold;">No. Of Test Failures</td>
                                   <td style="text-align: center;color:${errorColor};font-weight: bold;">${y.attachments[0].fields[3].value}</td>
                               </tr>
                               <tr>
                                  <td colspan="2" align="center" style="font-size: 20px;font-weight: bold;">Test passed details </td>
                               </tr>
                               <tr>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass1A}</td>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass1B}</td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass2A}</td>
                                  <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass2B}</td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://apiuat.vootkids.com/app/curated/v1/kidsCharacters.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass2C}</a></td>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://api.vootkids.com/app/curated/v1/kidsCharacters.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass2D}</a></td>
                               </tr>
                               <tr>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass3A}</td>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass3B}</td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://apiuat.vootkids.com/app/curated/v1/kidsMovies.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass3C}</a></td>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://api.vootkids.com/app/curated/v1/kidsMovies.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass3D}</a></td>
                               </tr>
                               <tr>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass4A}</td>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass4B}</td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://apiuat.vootkids.com/app/ks/v1/allKidsAudios.json?pageSize=8&pageIndex=0">${y.attachments[0].fields[4].value = pass4C}</a></td>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://api.vootkids.com/app/ks/v1/allKidsAudios.json?pageSize=8&pageIndex=0">${y.attachments[0].fields[4].value = pass4D}</a></td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://apiuat.vootkids.com/app/curated/v1/kidsAudios.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass4E}</a></td>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://api.vootkids.com/app/curated/v1/kidsAudios.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass4F}</a></td>
                               </tr>
                               <tr>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass5A}</td>
                                 <td style="text-align: center;color: green;font-weight: bold;" >${y.attachments[0].fields[4].value = pass5B}</td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://apiuat.vootkids.com/app/ebook/v1/allKidsEbooks.json?pageSize=8&pageIndex=0">${y.attachments[0].fields[4].value = pass5C}</a></td>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://api.vootkids.com/app/ebook/v1/allKidsEbooks.json?pageSize=8&pageIndex=0">${y.attachments[0].fields[4].value = pass5D}</a></td>
                               </tr>
                               <tr>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://apiuat.vootkids.com/app/curated/v1/kidsEbooks.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass5E}</a></td>
                                  <td style="text-align: center;font-weight: bold;"><a href="https://api.vootkids.com/app/curated/v1/kidsEbooks.json?limit=8&offSet=0">${y.attachments[0].fields[4].value = pass5F}</a></td>   
                               </tr>                                                                                              
                               <tr>
